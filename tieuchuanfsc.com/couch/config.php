<?php
    ...
    if (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == "https") {
       // define( 'K_SITE_URL', 'https://tieuchuanfsc.com/' ); 
       define( 'K_HTTPS', 1 ); 
       $_SERVER['HTTPS'] = 'on';
       $_SERVER['SERVER_PORT'] = 443;
    }
    // define( 'K_SITE_URL', 'http://tieuchuanfsc.com' );
    // define( 'K_SITE_URL', '/' );
    ...
    define( 'K_DB_NAME', 'luongltd_tieuchuanfsc' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'luongltd_root' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', '123123' );
    // 7.
