...
<cms:template title="Dịch vụ tư vấn">
    <cms:editable name="consult_content" label='Nội dung' desc='Nội dung' type="richtext" />
            ...
            <div class="col-lg-9 col-md-8 col-sm-7">
                ...
                <nav class="bread-crumb">
                    <ul class="breadcrumb clearfix">
                        ...
                        <li><li class="active">Dịch vụ tư vấn</li>
                    </ul>
                </nav>
            </div>
        </div>
...
<div class="row">
<ul>
    <cms:pages masterpage="chi-tiet-tu-van.php" paginate='0' limit='5'>
        <li><cms:show k_page_title /><a href="<cms:show k_page_link />" style="margin-left: 2%;"> ( Xem chi tiết ) » </a></li>
    </cms:pages>
</ul>
</div>
