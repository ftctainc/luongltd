...
<div class="col-lg-9 col-md-8">
    ...
    <cms:pages masterpage="chi-tiet-cau-hoi-thuong-gap.php" paginate='1' limit='10' folder=k_folder_name>
        <!-- Post -->
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="right-contents">
                        ...
                        <cms:excerptHTML count='75' ignore='img'><cms:show qa_description /> </cms:excerptHTML>
                        </div>
                        <!--read more button-->
        ...
        <cms:if k_paginated_bottom >
            <cms:paginator prev_text="<" next_text=">" />
        </cms:if>
        </cms:pages>
    </div>
</div>
