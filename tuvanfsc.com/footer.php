...
<footer id="footer">
	<div class="footer-top">
		...
		<aside class="col-xs-12 col-sm-6 col-md-3 widget links">
			...
			<nav>
				<ul>
					<li><a>Công ty TNHH Tư Vấn FSC Solutions</a></li>
					<li><a href="mailto:ctyfscsolutions@gmail.com">Email: <cms:show g_email_address /></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="copyright col-xs-12 col-sm-3 col-md-3">
				Copyright 2008 - 2017 © tuvanfsc.com . All rights reserved (hosted by <a href="https://songphi.com.vn/" target="_blank">songphi web solution</a>)
			</div>
